...
namespace FoodCorner.Migrations
{
    ...
    [Migration("20230330172532_AlertMessage")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FoodCorner.Database.Models.AboutVidio", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FoodCorner.Database.Models.AlertMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FoodCorner.Database.Models.Blog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FoodCorner.Database.Models.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FoodCorner.Database.Models.BlogAndBlogCategory", b =>
                {
                    b.HasOne("FoodCorner.Database.Models.BlogCategory", "Category")
                        .WithMany("BlogCategories")
                        .HasForeignKey("BlogCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FoodCorner.Database.Models.Blog", "Blog")
                        .WithMany("BlogCategories")
            ...
            modelBuilder.Entity("FoodCorner.Database.Models.BlogAndBlogTag", b =>
                {
                    ...
                    b.HasOne("FoodCorner.Database.Models.BlogTag", "Tag")
                        .WithMany("Tags")
            ...
            modelBuilder.Entity("FoodCorner.Database.Models.BlogCategory", b =>
                {
                    b.HasOne("FoodCorner.Database.Models.BlogCategory", "Parent")
                        .WithMany("Categoris")
